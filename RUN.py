...
class Canvas:
    ...
    def __init__(self, width, height):
        ...
        pygame.display.set_caption("META")
...
##                print(b/len(allfps))
        ...
        try:
            ...
            menuController.save_settings()
            calculate_statistics()
            logging.warning("META has crashed. Please send this report to MaxwellSalmon, so he can fix it.")
...
if __name__ == '__main__':
    ...
    beta = TEXT.Text(5,5,"META  ALFA  BUILD  V.1.6", SETTINGS.WHITE, "DUGAFONT.ttf", 20)
